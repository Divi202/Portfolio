...
const Slide = ({ slide, index, current, handleSlideClick }: SlideProps) => {
  ...
  const { src, githubLink, liveDemoLink, title, description, technologies } =
    slide;
...
const CarouselControl = ({
  ...
  return (
    <button
      className={`w-10 h-10 flex items-center mx-2 mt-4 justify-center bg-neutral-200 dark:bg-neutral-800 border-3 border-transparent rounded-full focus:border-[#f43f5e] focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
